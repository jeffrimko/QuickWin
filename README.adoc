...
== Status
The status of this project is **deprecated**. This project will likely no longer be updated as it is superseded by https://github.com/jeffrimko/PyQuickWin[PyQuickWin].
